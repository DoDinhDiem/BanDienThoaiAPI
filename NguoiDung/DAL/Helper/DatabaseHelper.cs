...
namespace DAL.Helper
{
    public class DatabaseHelper : IDatabaseHelper
    {
        ...
        /// <summary>
        /// Mở Kết nối với PostGres DB
        /// </summary>
        /// <returns>String.Empty khi được kết nối hoặc Lỗi thông báo khi kết nối xảy ra sự cố</returns>
        ...
        /// <summary>
        /// Mở Connect bắt đầu giao dịch với PostGres DB
        /// </summary>
        /// <returns> String.Empty khi được kết nối hoặc Lỗi thông báo khi kết nối xảy ra sự cố</returns>
        ...
        /// <summary>
        /// Đóng Kết nối và kết thúc giao dịch với PostGres DB
        /// </summary>
        ...
        /// <param name="paramObjects">Liệt kê các đối tượng Param, mỗi mục bao gồm 'ParamName' và 'ParamValue'</param>
        /// <returns>String.Empty khi chạy truy vấn thành công hoặc Thông báo Lỗi khi chạy truy vấn xảy ra sự cố</returns>
        ...
        /// <summary>
        /// Thực hiện truy vấn thủ tục vô hướng Danh sách lưu trữ và lệnh
        /// </summary>
        /// <param name="storeParameterInfos"> Danh sách Store và ListList Tham số</param>
        /// <returns> Liệt kê msgErrors trả về từ storeprocedure</returns>
        ...
        /// <summary>
        /// Thực hiện Thủ tục truy vấn Danh sách lưu trữ với giao dịch
        /// </summary>
        /// <param name="storeParameterInfos">Danh sách Store và ListList Tham số</param>
        /// <returns>Liệt kê msgErrors trả về từ storeprocedure</returns>
        ...
        /// <summary>
        /// Thực hiện truy vấn thủ tục vô hướng
        /// </summary>
        /// <param name="msgError">String.Empty khi chạy truy vấn thành công hoặc Thông báo Lỗi khi chạy truy vấn xảy ra sự cố</param>        
        /// <param name="sprocedureName">Tên thủ tục</param>
        /// <param name="paramObjects">Liệt kê các đối tượng Param, mỗi mục bao gồm 'ParamName' và 'ParamValue'</param>
        /// <returns>Giá trị hoàn trả từ Cửa hàng</returns>
        ...
        /// </summary>
        /// <param name = "msgError"> String.Empty khi chạy truy vấn thành công hoặc Lỗi thông báo khi sự cố chạy truy vấn </param>
        /// <param name = "ridcedureName"> Tên thủ tục </param>
        /// <param name = "paramObjects"> Liệt kê các đối tượng tham số, mỗi mục bao gồm 'ParamName' và 'ParamValue' </param>
        /// <returns> Kết quả bảng </returns>
